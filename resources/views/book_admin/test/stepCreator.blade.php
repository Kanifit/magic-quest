...
<head>
    ...
    <link href="{{ asset('css/step-creator.css') }}" rel="stylesheet">
    <link href="{{ asset('css/lightbox.css') }}" rel="stylesheet">
</head>
<body class="blockScroll theme-auto">
<div id="appStepCreator">
    <step-creator :steps="{{ $steps }}" :test=" {{ $test }}"></step-creator>
</div>

<!-- Scripts -->
<script src="{{ asset('js/manifest.js') }}"></script>
<script src="{{ asset('js/vendor.js') }}"></script>
<script src="{{ asset('js/step-creator.js') }}" defer></script>
</body>
</html>
